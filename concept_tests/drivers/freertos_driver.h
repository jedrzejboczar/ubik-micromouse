...
public:
    ...
    virtual QueueHandle_t create_queue(size_t queue_length, size_t data_size) override;
    ...
    virtual void send_response(QueueHandle_t response_queue, const void *from_buffer) override;
